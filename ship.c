...
GLint a=0,b=0,c=0,d=0,e=0,f=0,g=500,h=600,x=0,i=0,flag=0;
GLfloat theta=0.0;
...
void display3()
{
	...
	rock();
	glPushMatrix();
	glTranslated(c+180,100+x*5,0.0);
	glRotated(-20,0,0,1);
	ship();
	glPopMatrix();
	water();
...
void rock()
{
	...
	if(c>0)
	{
		...
		glBegin(GL_POLYGON);
		glVertex2f(8.1,11);
		glVertex2f(6.89,20.23);
		glVertex2f(11.26,24);
		glVertex2f(13.23,32.33);
		glVertex2f(18.23,16.53);
		glEnd();
		...
		glBegin(GL_POLYGON);
		glVertex2f(18.1,3.5);
		glVertex2f(20.2,18.7);
		glVertex2f(25.4,18.5);
		glVertex2f(27.12,3.65);
		glVertex2f(29.21,1.25);
		glEnd();
